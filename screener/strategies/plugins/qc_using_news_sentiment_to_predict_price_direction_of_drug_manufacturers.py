...
def _prepare_qc_using_news_sentiment_to_predict_price_direction_of_drug_manufacturers(ctx: PrepareCtx) -> dict[str, pd.DataFrame]:
    prepared = {}
...
def _lookback_qc_using_news_sentiment_to_predict_price_direction_of_drug_manufacturers() -> int:
    return 5
