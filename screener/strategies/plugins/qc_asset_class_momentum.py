...
def prepare_asset_class_mom(ctx: PrepareCtx) -> dict[str, pd.DataFrame]:
...
@strategy(
    "qc_asset-class-momentum",
    entry="signal == 1",
    exit="signal == 0",
    prepare_bars=prepare_asset_class_mom,
    required_lookback=lambda: 252,
)
def _qc_asset_class_momentum():
    pass
